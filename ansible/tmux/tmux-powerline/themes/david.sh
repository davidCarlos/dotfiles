...
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'#bb9af7'}
...
if [ -z "$TMUX_POWERLINE_WINDOW_STATUS_CURRENT" ]; then
	TMUX_POWERLINE_WINDOW_STATUS_CURRENT=(
		"#[fg=#414868,bg=$TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR,us=#1a1b26,bold]"
		" *#W "
	)
fi
...
if [ -z "$TMUX_POWERLINE_WINDOW_STATUS_FORMAT" ]; then
	TMUX_POWERLINE_WINDOW_STATUS_FORMAT=(
		"#[fg=#002b36,bg=$TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR]"
		" #W "
	)
fi
