...
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'gray'}
...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info ${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR} #1a1b26"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117"
		"time ${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR} 0"
	)
fi
