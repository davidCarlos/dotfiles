...
require('packer').startup(function(use)
  ...
  use { -- Autocompletion
    'hrsh7th/nvim-cmp',
    requires = { 'hrsh7th/cmp-nvim-lsp', 'L3MON4D3/LuaSnip', 'saadparwaiz1/cmp_luasnip', 'SirVer/ultisnips', 'quangnguyen30192/cmp-nvim-ultisnips', 'honza/vim-snippets', 'hrsh7th/cmp-cmdline' },
  }
...
local servers = { 'clangd', 'rust_analyzer', 'tsserver', 'lua_ls', 'gopls', 'pylsp' }
